...
$(document).ready(function(){
    ...
    var animation_begin_pos = 0; //where you want the animation to begin
		var animation_mid_pos = 2500;
		var animation_end_pos = 5000; //where you want the animation to stop
    var beginning_color = new $.Color( 'rgb(0,161,155)' ); //we can set this here, but it'd probably be better to get it from the CSS; for the example we're setting it here.
		var middle_color = new $.Color( 'rgb(36,40,47)' );
	  var ending_color = new $.Color( 'rgb(255,61,79)' ); ;//what color we want to use in the end
