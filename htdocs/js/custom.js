...
$(document).ready(function(){
    ...
    var scroll_pos = 0;
    var animation_begin_pos = -1; //where you want the animation to begin
    var animation_end_pos = 5200; //where you want the animation to stop
    var beginning_color = new $.Color( 'rgb(58,48,167)' ); //we can set this here, but it'd probably be better to get it from the CSS; for the example we're setting it here.
    var ending_color = new $.Color( 'rgba(93,201,255,0.37)' ); ;//what color we want to use in the end
